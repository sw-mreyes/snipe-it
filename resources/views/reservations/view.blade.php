...
<a href="{{ route('reservations.delete', ['reservationID' => $reservation->id]) }}" class="btn btn-sm btn-danger pull-right">{{ trans('reservations.delete') }} </a>
