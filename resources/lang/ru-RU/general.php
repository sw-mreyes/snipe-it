...
return [
    ...
    'unaccepted_profile_warning' => '{1} У вас есть один элемент, требующий подтверждения. Нажмите здесь, чтобы принять или отклонить его|[2,4] У вас есть :count элемента, требующих подтверждения. Нажмите здесь, чтобы принять или отклонить их|[5,*] У вас есть :count элементов, требующих подтверждения. Нажмите здесь, чтобы принять или отклонить их',
